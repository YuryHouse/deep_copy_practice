...
// man3FullCopy.friends[0].name = 'Dimon'
...
let man5FullCopy = {...man5,
    ...
    man5FullCopy.mother.parents[0].name = 'Sasha'
...
let man6FullCopy = {...man6,
    ...
    parents: {...man6.mother.parents.map(p=>({...p, favoriteDish: {...p.favoriteDish}}))}}}
    // man6FullCopy.mother.parents[0].favoriteDish = 'dumplings'
